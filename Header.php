        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li><a href="../Duque/static/ReservaSala1_7pm.html"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Reservas</a></li>
                    <li><a href="../Claeb/Vista/PerfilP.php"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Perfil</a></li>                                    
                    <li><a href="book.php"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Nueva Pelicula </a></li>
